...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
	...
	<object width="100%" height="100%">
      ...
      <param name="scale" value="noscale" /><param name="salign" value="lt"></param>
      <param name="allowFullScreen" value="true"></param><param name="allowscriptaccess" value="always"></param>
      <embed width="100%" height="100%" scale="noscale" salign="lt" src="<?=$swfurl?>" type="application/x-shockwave-flash" allowscriptaccess="always" allowfullscreen="true" base="<?php echo $base?>"></embed>
    </object>
