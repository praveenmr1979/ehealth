...
///spc          db_query("update {vwcredits_transaction} set applied=1,app_time=now() where room_nid=%d and type in ('roomcost','ownerscost','ownersgain','ownersroomcost') and applied=0", $fur->room_nid);
